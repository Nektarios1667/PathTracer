...
constexpr unsigned MIN_SAMPLES = RENDER_TYPE == RenderType::Light ? 2  : 1; // minimum adaptive samples
constexpr unsigned MAX_SAMPLES = RENDER_TYPE == RenderType::Light ? 4 : 1; // cutoff for adaptive sampling
