...
constexpr unsigned MIN_SAMPLES = RENDER_TYPE == RenderType::Light ? 16  : 1; // minimum adaptive samples
constexpr unsigned MAX_SAMPLES = RENDER_TYPE == RenderType::Light ? 64 : 1; // cutoff for adaptive sampling
