...
constexpr unsigned MIN_DEPTH   = SIMPLE_RENDER ? 1  : 4; // minimum bounces
constexpr unsigned MAX_DEPTH   = SIMPLE_RENDER ? 1  : 6; // max bounced to prevent too much recursion
